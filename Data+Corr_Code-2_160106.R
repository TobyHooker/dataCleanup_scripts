...
#####  STEP 2   Merge Data sets, Export to XL, cleanup, then restart #######
Chem0 <- WChem3
Invert0 <- INV1
...
Chem.Invert.SAV_1 <- read.csv("C:/Users/tobyhooker/Dropbox/REFSTD_R/Chem.Invert.SAV_1.csv")
   ...
   COR.dat1 <- COR.dat0  ## working copy...
...
########  UPDATE  ::  R E D O  A N A L Y S I S  : -WSpur & !is.na(IP_calc) ######
Chem.Invert.SAV_1




#####  Metab_DO.p is corrupted -- DO NOT USE !!!  #######
